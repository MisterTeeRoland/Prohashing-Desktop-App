    ...
    return (
        <div className="modalBackground" onClick={onClose}>
            <div className="modal">
                ...
                <div className="listItem">
                    4. In the Security tab, scroll down to the "API Key
                    Settings" area.
                </div>
                <br></br>
                <div>
                    If you do not have an existing API key, click "New Key" to
                    generate a new API key.
                </div>
                <br></br>
                <div>
                    Copy and paste your API key into the field in this app, and
                    then press save.
                </div>
            </div>
        </div>
